var NS_XHTML2 = "http://www.w3.org/TR/xhtml2";
...
if (typeof document.documentElement.setAttributeNS != 'undefined') {
  ...
  function hasAttribute(elmTarget, sAttrName) {
    return getAttribute(elmTarget, sAttrName) != null;
  }
};
...
function setRolesAndStates(elmAccessible)
{
  ...
  for (j = 0; j < arClassNames.length; j++) {
    ...
    if (sClass == 'axs') {
      ...
      //alert('Role of ' + elmAccessible.nodeName + ' ' + elmAccessible.id + ' is ' + getAttrNS(elmAccessible, NS_XHTML2, "role"));
